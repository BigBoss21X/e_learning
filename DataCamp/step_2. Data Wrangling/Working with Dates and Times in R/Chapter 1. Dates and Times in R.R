...
# Chapter 4. Arithmetic and logical operators
...
# (1) Find the date of the most recent release by calling max() on the date column in releases.
# Find the largest date
last_release_date <- max(releases$date)

# (2) Find the rows in releases that have the most recent date, by specifying the comparison date == last_release_date in filter()
# Filter row for last release

last_release <- dplyr::filter(releases, date == last_release_date)

# (3) Print last_release to see which release this was.
# Print last_release
last_release

# (4) Calculate how long it has been since the most recent release by subtracting last_release_date from Sys.Date().
# How long since last release?
Sys.Date() - last_release_date

# Chapter 5. Getting datetimes into R
...
# Chapter 6. Datetimes behave nicely too
